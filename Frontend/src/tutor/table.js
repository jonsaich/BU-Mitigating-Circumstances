...
class MitTable extends Component {
  ...
  render() {
    ...
    var mitCircumsList = this.props.mitCircums.map(function(mitC){
      return (
        <MitRow getMitigatingCircumstancesFromAPI={global.props.getMitigatingCircumstancesFromAPI} updateAlert={global.props.updateAlert} user={global.props.user} modalSettings={global.props.modalSettings} data={mitC} />
      );
    })
...
class MitRow extends Component {
  ...
  handleViewClick() {
    this.props.modalSettings.changeContent(<MitigatingCircumstance getMitigatingCircumstancesFromAPI={this.props.getMitigatingCircumstancesFromAPI} updateAlert={this.props.updateAlert} modalSettings={this.props.modalSettings} user={this.props.user} formData={this.props.data} />)
  ...
  render() {
    return (
      <tr>
        <th scope="row">{this.props.data.student.firstName} {this.props.data.student.lastName}</th>
